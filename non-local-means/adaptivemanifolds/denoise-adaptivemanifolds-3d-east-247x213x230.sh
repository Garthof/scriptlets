...
global_variables() {
    ...
    global_volume_name="Ammonit-Eo_u-cropped-247x213x230.vol.mat"
    global_experiment_name="denoise-adaptivemanifolds-3d-east-247x213x230"
    global_input_path="/vis/data/people/bzflamas/AmmoniteDenoising/datasets/volumes/Ammonit-Nano-CT/matlab/east-247x213x230"
