...
proc denoiseVolume {inVolume inOrthoSlice iterVal windowVal similVal} {
    ...
    $outOrthoSlice sliceOrientation setValue 0
...
set volPath {/media/data/bzflamas/AmmoniteDenoising/datasets/volumes/Ammonit-Nano-CT/amira/center-141x151x180/Ammonit-Eo_u-cropped-141x151x180-YZ.vol.am}
...
$origOrthoSlice sliceOrientation setValue 0
