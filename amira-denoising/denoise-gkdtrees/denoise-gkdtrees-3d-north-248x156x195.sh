...
global_variables() {
    ...
    global_volume_name="Ammonit-Eo_u-cropped-248x156x195.vol.am"
    global_experiment_name="denoise-gkdtrees-3d-north-248x156x195"
    global_input_path="/vis/data/people/bzflamas/AmmoniteDenoising/datasets/volumes/Ammonit-Nano-CT/amira/north-248x156x195"
